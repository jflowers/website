...
- [dnrTV Screencast with Scott Hanselman](https://www.hanselman.com/blog/continuous-integration-screencast-jay-flowers-and-i-on-dnrtv) -- Setting up CI Factory on a totally fresh machine
- [Building CI in an Hour with Phil Haack](https://haacked.com/archive/2007/04/29/building-a-continuous-integration-process-in-an-hour-on-dnrtv.aspx/)

### Related Posts

- [A Recipe for Build Maintainability and Reusability](/wiki/a-recipe-for-build-maintainability-and-reusability/)
- [AsyncExec and WaitForExit: Speeding Up The Build To Do More](/blog/asyncexec-and-waitforexit-speeding-up-the-build-to-do-more/)
